...
describe('fs-store', () => {
  ...
  describe('initCortexDir', () => {
    it('creates .cortex directory structure', async () => {
      await initCortexDir(safeFs)
      expect(fs.existsSync(path.join(tmpDir, '.cortex', 'index', 'symbols'))).toBe(true)
      expect(fs.existsSync(path.join(tmpDir, '.cortex', 'index', 'schema'))).toBe(true)
      expect(fs.existsSync(path.join(tmpDir, '.cortex', 'index', 'config'))).toBe(true)
      expect(fs.existsSync(path.join(tmpDir, '.cortex', '.gitignore'))).toBe(true)
    })
  })
