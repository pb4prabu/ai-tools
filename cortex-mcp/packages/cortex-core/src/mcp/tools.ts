...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    name: 'index_folder',
    description:
      'Force a full re-index of the project. Normally not needed — Cortex auto-indexes on startup and incrementally on every query. Use only if you suspect the index is stale.',
    inputSchema: {
      type: 'object',
      properties: {
        full: {
