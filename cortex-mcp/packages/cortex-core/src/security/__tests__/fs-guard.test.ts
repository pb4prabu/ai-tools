...
describe('SafeFS', () => {
  ...
  describe('assertWriteAllowed', () => {
    it('allows writes within .cortex/', () => {
      expect(() => safeFs.assertWriteAllowed('/home/user/myapp/.cortex/index/symbols/test.json')).not.toThrow()
    })
  ...
  describe('getters', () => {
    ...
    it('returns correct cortex dir', () => {
      expect(safeFs.getCortexDir()).toBe('/home/user/myapp/.cortex')
    })

    it('returns correct index dir', () => {
      expect(safeFs.getIndexDir()).toBe('/home/user/myapp/.cortex/index')
    })
  })
})
