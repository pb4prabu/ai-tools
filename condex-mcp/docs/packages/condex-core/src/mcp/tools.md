...
**Path:** `packages/condex-core/src/mcp/tools.ts`

## What it does

Defines the JSON schemas for all 10 MCP tools that Condex exposes to AI agents. This is pure data — no logic. Each tool definition has a name, description, and JSON Schema for its input parameters.
